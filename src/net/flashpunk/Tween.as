package net.flashpunk 
{
	...
	public class Tween 
	{
		...
		/**
		* Ping Pong Tween type, A looping tween that will reverse itself when it finishes.
		*/
		public static const PINGPONG:uint = 3;
		...
		/**
		 * The rate of execution of the tween.
		 */
		...
		public function updatePingPong():void
		{
			if (_ponging)
			{
				_time -= FP.timeInFrames ? 1 : FP.elapsed * rate;
				_t = _time / _target;
        ...
        /** @private */ private var _ponging:Boolean = false;
		// Timing information.
